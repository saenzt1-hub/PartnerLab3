...
along with how interesting they look in the game. They really stood out to us when we were learning about animations in Swift.
We already had the ease animations to add a little "bedazzle" to the game, which we thought looked really nice.
These ease animations are seen throughout the MemoryGameViewModel, ContentView, and CardView files! (Apologies, my XCode was acting out so that's why it can't be seen much in the video!!)
So, we wanted to add another one, spring!
We, Taina and Tori, hope that you find this game enjoyable!

Video/Demo for Animation:

https://youtu.be/RWKaeW4Thd8
